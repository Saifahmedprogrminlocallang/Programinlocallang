...
*/	  
      ...
      StringBuffer strCurrentLineBuffer = new StringBuffer("//input program line \n");
	  StringBuffer strInputProgram = new StringBuffer("//input program \n");
	  String strCurrentLine ="//input program line" +  "\n";
	  ...
	  try {
		  ...
		  BufferedReader br = new BufferedReader(new FileReader(localLangFilename));
		    ...
		    while ((strCurrentLine = br.readLine()) != null) {
				strCurrentLineBuffer.append(strCurrentLine);
				strreadline = strCurrentLine.toString();
				
		    // System.out.println(strCurrentLine);
			strInputProgram.append(strreadline);
		    strFile = strFile + " \n" + strreadline;
...
//	    hm52.put(counter3, keyword31); // custom api tobemapped
	  ...
	  String localLangoutputFilename = "D:\\Saif\\LocallangProgram\\Outputbinaryfile.dat";
	  try {
